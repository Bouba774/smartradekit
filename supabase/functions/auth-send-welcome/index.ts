...
const translations: Record<string, {
  ...
  en: {
    ...
    intro: "Congratulations on joining the PipsKit community! You've taken the first step towards a more structured and professional trading approach.",
    ...
    footerNote: 'You received this email because you just created your PipsKit account.',
    tagline: 'Your intelligent trading journal'
  },
  fr: {
    subject: (name) => `🎉 Bienvenue ${name} ! Votre aventure trading commence`,
    welcome: (name) => `Bienvenue ${name} !`,
    intro: "Félicitations pour avoir rejoint la communauté PipsKit ! Vous avez fait le premier pas vers une approche plus structurée et professionnelle du trading.",
    ...
    footerNote: 'Vous recevez cet email car vous venez de créer votre compte PipsKit.',
    tagline: 'Votre journal de trading intelligent'
  },
  es: {
    subject: (name) => `🎉 ¡Bienvenido ${name}! Tu viaje de trading comienza`,
    welcome: (name) => `¡Bienvenido ${name}!`,
    intro: "¡Felicidades por unirte a la comunidad PipsKit! Has dado el primer paso hacia un enfoque de trading más estructurado y profesional.",
    ...
    footerNote: 'Recibiste este email porque acabas de crear tu cuenta de PipsKit.',
    tagline: 'Tu diario de trading inteligente'
  },
  pt: {
    subject: (name) => `🎉 Bem-vindo ${name}! Sua jornada de trading começa`,
    welcome: (name) => `Bem-vindo ${name}!`,
    intro: "Parabéns por se juntar à comunidade PipsKit! Você deu o primeiro passo para uma abordagem de trading mais estruturada e profissional.",
    ...
    footerNote: 'Você recebeu este email porque acabou de criar sua conta PipsKit.',
    tagline: 'Seu diário de trading inteligente'
  },
  de: {
    subject: (name) => `🎉 Willkommen ${name}! Ihre Trading-Reise beginnt`,
    welcome: (name) => `Willkommen ${name}!`,
    intro: "Herzlichen Glückwunsch zum Beitritt zur PipsKit-Community! Sie haben den ersten Schritt zu einem strukturierteren und professionelleren Trading-Ansatz gemacht.",
    ...
    footerNote: 'Sie haben diese E-Mail erhalten, weil Sie gerade Ihr PipsKit-Konto erstellt haben.',
  ...
  it: {
    ...
    intro: "Congratulazioni per esserti unito alla community di PipsKit! Hai fatto il primo passo verso un approccio al trading più strutturato e professionale.",
    ...
    footerNote: 'Hai ricevuto questa email perché hai appena creato il tuo account PipsKit.',
  ...
  tr: {
    ...
    intro: "PipsKit topluluğuna katıldığın için tebrikler! Daha yapılandırılmış ve profesyonel bir trading yaklaşımına doğru ilk adımı attın.",
    ...
    footerNote: 'Bu e-postayı, PipsKit hesabınızı yeni oluşturduğunuz için aldınız.',
    tagline: 'Akıllı trading günlüğünüz'
  },
  ar: {
    subject: (name) => `🎉 مرحباً ${name}! رحلتك في التداول تبدأ`,
    welcome: (name) => `مرحباً ${name}!`,
    intro: "تهانينا على انضمامك إلى مجتمع PipsKit! لقد اتخذت الخطوة الأولى نحو نهج تداول أكثر تنظيماً واحترافية.",
    ...
    footerNote: 'تلقيت هذا البريد الإلكتروني لأنك أنشأت للتو حساب PipsKit الخاص بك.',
