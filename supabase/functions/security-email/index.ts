...
const getEmailContent = (request: SecurityEmailRequest) => {
  ...
  switch (type) {
    case 'new_device':
      return {
        subject: language === 'fr' 
          ? '🔔 Nouvelle connexion détectée - PipsKit'
          : '🔔 New login detected - PipsKit',
        html: language === 'fr' ? `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0;">
              ...
              <p style="color: #64748b; line-height: 1.6;">
                Une connexion à votre compte PipsKit a été effectuée depuis un nouvel appareil :
              </p>
              ...
              <p style="color: #94a3b8; font-size: 12px; margin-top: 30px; text-align: center;">
                Cet email a été envoyé automatiquement par PipsKit.<br>
        ...
        ` : `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0;">
              ...
              <p style="color: #64748b; line-height: 1.6;">
                A login to your PipsKit account was made from a new device:
              </p>
              <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0; margin: 20px 0;">
                <table style="width: 100%; border-collapse: collapse;">
                  <tr>
              ...
              <p style="color: #94a3b8; font-size: 12px; margin-top: 30px; text-align: center;">
                This email was sent automatically by PipsKit.<br>
    ...
    case 'account_blocked':
      return {
        subject: language === 'fr'
          ? '🔒 Compte temporairement bloqué - PipsKit'
          : '🔒 Account temporarily blocked - PipsKit',
        html: language === 'fr' ? `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0;">
              ...
              <p style="color: #64748b; line-height: 1.6;">
                Votre compte PipsKit a été temporairement bloqué suite à plusieurs tentatives de connexion infructueuses.
              </p>
              ...
              <p style="color: #94a3b8; font-size: 12px; margin-top: 30px; text-align: center;">
                Cet email a été envoyé automatiquement par PipsKit.
              </p>
            </div>
          </div>
        ` : `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0;">
              ...
              <p style="color: #64748b; line-height: 1.6;">
                Your PipsKit account has been temporarily blocked due to multiple unsuccessful login attempts.
              </p>
              <div style="background: #fee2e2; padding: 20px; border-radius: 8px; border: 1px solid #fecaca; margin: 20px 0;">
                <p style="color: #991b1b; margin: 0;">
              ...
              <p style="color: #94a3b8; font-size: 12px; margin-top: 30px; text-align: center;">
                This email was sent automatically by PipsKit.
              </p>
            </div>
          </div>
        `
    ...
    case 'pin_reset':
      return {
        subject: language === 'fr'
          ? '🔑 Réinitialisation de votre code PIN - PipsKit'
          : '🔑 Reset your PIN code - PipsKit',
        html: language === 'fr' ? `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "PipsKit <security@smartradekit.lovable.app>",
        to: [request.email],
        subject,
        html,
      }),
