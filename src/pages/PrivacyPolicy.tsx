...
const PrivacyPolicy: React.FC = () => {
  ...
  const contentFR = (
    <>
      ...
      <p className="mb-6">
        La présente Politique de Confidentialité explique comment PipsKit (« l'Application », « nous ») collecte, utilise, protège et traite les données personnelles de ses utilisateurs (« vous »). Nous nous engageons à respecter le Règlement Général sur la Protection des Données (RGPD) et toutes les lois applicables.
      </p>
  ...
  const contentEN = (
    <>
      ...
      <p className="mb-6">
        This Privacy Policy explains how PipsKit ("the Application", "we") collects, uses, protects, and processes personal data of its users ("you"). We comply with the General Data Protection Regulation (GDPR) and applicable laws.
      </p>
