...
const TermsOfUse: React.FC = () => {
  ...
  const contentFR = (
    <>
      ...
      <p className="text-muted-foreground mb-4">En utilisant l'application PipsKit, vous acceptez ces Conditions dans leur intégralité.</p>

      <h2 className="text-xl font-bold text-foreground mt-8 mb-4">2. Objet de l'application</h2>
      <p className="text-muted-foreground mb-2">PipsKit est une application de journal de trading offrant :</p>
  ...
  const contentEN = (
    <>
      ...
      <p className="text-muted-foreground mb-4">By using PipsKit, you agree to these Terms in their entirety.</p>

      <h2 className="text-xl font-bold text-foreground mt-8 mb-4">2. Application Purpose</h2>
      <p className="text-muted-foreground mb-2">PipsKit is a trading journal application offering:</p>
      <ul className="list-disc list-inside mb-4 space-y-1 text-muted-foreground">
