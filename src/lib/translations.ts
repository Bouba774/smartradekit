// Complete translation system for PipsKit
...
export const translations: Translations = {
  ...
  aboutDesc: { fr: 'En savoir plus sur PipsKit', en: 'Learn more about PipsKit' },
  aboutSmartTradeTracker: { fr: 'À Propos de PipsKit', en: 'About PipsKit' },
  missionStatement: { fr: 'Notre Mission', en: 'Our Mission' },
  missionDesc: { fr: "PipsKit a été créé avec un seul objectif : aider les traders à développer la discipline et la clarté dont ils ont besoin pour réussir. Nous croyons que la rentabilité constante vient de la compréhension de votre psychologie, du suivi de vos données et de l'apprentissage de chaque trade. Notre mission est de fournir les outils qui transforment un trading dispersé en un parcours structuré et basé sur les données vers la maîtrise.", en: "PipsKit was created with one purpose: to help traders develop the discipline and clarity they need to succeed. We believe that consistent profitability comes from understanding your psychology, tracking your data, and learning from every trade. Our mission is to provide the tools that turn scattered trading into a structured, data-driven journey toward mastery." },
  whatIs: { fr: "Qu'est-ce que PipsKit?", en: 'What is PipsKit?' },
  whatIsDesc: { fr: "PipsKit est un journal de trading complet conçu pour vous aider à suivre chaque trade, analyser vos performances et maîtriser vos émotions. Il résout les problèmes les plus courants rencontrés par les traders :", en: "PipsKit is a comprehensive trading journal designed to help you track every trade, analyze your performance, and master your emotions. It solves the most common problems traders face:" },
  ...
  whatMakesUnique: { fr: 'Ce Qui Rend PipsKit Unique', en: 'What Makes PipsKit Unique' },
